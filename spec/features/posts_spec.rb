...
RSpec.feature "Posts", type: :feature do
  ...
  scenario "user submit duplicated cards on /result page" do
      visit '/result'
      fill_in "post[card_info]", with: "S1 S2 S3 S4 S4"
      click_button "Check"
  ...
  scenario "user submit wrong card for first card on /result page" do
    visit '/result'
    fill_in "post[card_info]", with: "X1 S2 S3 S4 S5"
    click_button "Check"
  ...
  scenario "user submit wrong card for second card on /result page" do
    visit '/result'
    fill_in "post[card_info]", with: "S1 X2 S3 S4 S5"
    click_button "Check"
  ...
  scenario "user submit wrong card for third card on /result page" do
    visit '/result'
    fill_in "post[card_info]", with: "S1 S2 X3 S4 S5"
    click_button "Check"
  ...
  scenario "user submit wrong card for fourth card on /result page" do
    visit '/result'
    fill_in "post[card_info]", with: "S1 S2 S3 X4 S5"
    click_button "Check"
  ...
  scenario "user submit wrong card for fifth card on /result page" do
    visit '/result'
    fill_in "post[card_info]", with: "S1 S2 S3 S4 X5"
    click_button "Check"
